...
| 98   | [Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree/)                                               | Medium     | DFS with min/max bounds | O(n)            | O(h)         |
...
| 133  | [Clone Graph](https://leetcode.com/problems/clone-graph/)                                                                               | Medium     | DFS + hash map         | O(V + E)         | O(V)         |
...
| 278  | [First Bad Version](https://leetcode.com/problems/first-bad-version/)                                                                   | Easy       | Binary search          | O(log n)         | O(1)         |
...
| 338  | [Counting Bits](https://leetcode.com/problems/counting-bits/)                                                                           | Easy       | DP (bit shift recurrence) | O(n)          | O(n)         |
| 347  | [Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/)                                                       | Medium     | Hash map + sort        | O(n log n)       | O(n)         |
| 383  | [Ransom Note](https://leetcode.com/problems/ransom-note/)                                                                               | Easy       | Hash map (freq count)  | O(m + n)         | O(k)         |
| 389  | [Find the Difference](https://leetcode.com/problems/find-the-difference/)                                                               | Easy       | Hash map (freq count)  | O(n)             | O(n)         |
...
| 547  | [Number of Provinces](https://leetcode.com/problems/number-of-provinces/)                                                               | Medium     | Union-Find (path compression) | O(n²)     | O(n)         |
...
| 682  | [Baseball Game](https://leetcode.com/problems/baseball-game/)                                                                           | Easy       | Stack (operation replay) | O(n)           | O(n)         |
| 703  | [Kth Largest Element in a Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream/)                                      | Easy       | Min-heap (size k)      | O(log k) add     | O(k)         |
...
| 1859 | [Sorting the Sentence](https://leetcode.com/problems/sorting-the-sentence/)                                                             | Easy       | Split + index placement | O(n)            | O(n)         |
